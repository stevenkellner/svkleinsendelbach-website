...
@Component({
  selector: 'app-football-adults-first-team-results',
  templateUrl: './results.component.html',
  styleUrls: ['./results.component.sass']
})
export class FootballAdultsFirstTeamResultsComponent implements AfterViewInit {
    ...
    ngAfterViewInit() {
        const teamId = "016PBE74S0000000VV0AG80NVV8OQVTB";
        const options = {
