...
@Component({
  selector: 'app-football-youth-e-results',
  templateUrl: './results.component.html',
  styleUrls: ['./results.component.sass']
})
export class FootballAYouthEResultsComponent implements AfterViewInit {
    ...
    ngAfterViewInit(): void {
        const teamId = '01L3BHPM88000000VV0AG811VV4PB99G';
        const options = {
        ...
        iFrame.src = bfvHost + appPath + '&widget=' + encodeURIComponent('widget/team/complete/team' + teamId + '/' + options.selectedTab
            + '?css=' + encodeURIComponent(JSON.stringify(options)) + '&referrer=' + window.location.hostname);
